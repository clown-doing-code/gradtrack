...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] relative isolate w-[420px] transition-transform will-change-transform [aspect-ratio:21/13] [contain:layout_style] [perspective:600px]"
      ref={refElement}
      onPointerMove={(event) => {
